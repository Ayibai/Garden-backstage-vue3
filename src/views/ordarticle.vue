<template>
  <div class="ord_body_all">
    ...
    >
      <div class="ord_btn">
        <div class="ord_title">普通文章管理</div>
      </div>
      <div style="width: 90%; margin-top: 10px">
        ...
        <el-table :data="data.ordInfo1" height="451px" style="width: 100%">
...
export default {
  ...
  setup() {
    ...
    function getPageData() {
      ...
      data.ordInfo1 = data.ordInfo.slice(start, end);
      // console.log(start)
      // console.log(end)
    ...
    function encyclopediasInfo() {
      proxy.$http
        .post("/ordarticle/info", {
          username: "admin",
        })
        .then((res) => {
          // console.log(res);
          data.ordInfo = res.data;
          getPageData(); //分页
          // console.log(data);
        });
    }
